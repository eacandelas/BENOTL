...
U 1 1 5A821F87
P 2900 7450
F 0 "#PWR8" H 2900 7200 50  0001 C CNN
...
U 1 1 5A823B5C
P 8285 1895
F 0 "U1" H 7785 2895 60  0000 C CNN
F 1 "esp8266-12" H 7535 1845 60  0000 C CNN
F 2 "talentBadge:ESP-12E_SMD" H 7735 2045 60  0001 C CNN
F 3 "" H 7735 2045 60  0000 C CNN
	1    8285 1895
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A8731F6
P 2550 3100
F 0 "#PWR6" H 2550 2850 50  0001 C CNN
...
U 1 1 5A87C4F2
P 4350 3100
F 0 "#PWR11" H 4350 2850 50  0001 C CNN
...
U 1 1 5A87E79A
P 6150 3100
F 0 "#PWR16" H 6150 2850 50  0001 C CNN
...
U 1 1 5A884E23
P 1700 6900
F 0 "#PWR3" H 1700 6650 50  0001 C CNN
...
F 3 "" H 2250 6200 50  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 9635 1545 2    50   Input ~ 0
np
...
U 1 1 5A888CD9
P 1000 950
F 0 "#PWR1" H 1000 800 50  0001 C CNN
...
U 1 1 5A88959B
P 4550 950
F 0 "#PWR12" H 4550 800 50  0001 C CNN
...
U 1 1 5A889CBB
P 6985 895
F 0 "#PWR19" H 6985 745 50  0001 C CNN
F 1 "+3.3V" H 6985 1035 50  0000 C CNN
F 2 "" H 6985 895 50  0000 C CNN
F 3 "" H 6985 895 50  0000 C CNN
	1    6985 895 
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A889D35
P 9385 2045
F 0 "#PWR23" H 9385 1795 50  0001 C CNN
F 1 "GND" H 9385 1895 50  0000 C CNN
F 2 "" H 9385 2045 50  0000 C CNN
F 3 "" H 9385 2045 50  0000 C CNN
	1    9385 2045
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A88A940
P 9385 1545
F 0 "R2" V 9430 1620 50  0000 L CNN
F 1 "470" V 9390 1470 50  0000 L CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" H 9385 1545 50  0001 C CNN
F 3 "" H 9385 1545 50  0000 C CNN
	1    9385 1545
	0    1    1    0   
$EndComp
...
RXD
Text GLabel 9285 1045 2    50   Output ~ 0
TXD
Text GLabel 9285 1145 2    50   Input ~ 0
RXD
Text GLabel 4350 6550 2    50   Output ~ 0
B1
Text GLabel 4350 6700 2    50   Output ~ 0
B2
Text GLabel 9285 1245 2    50   Input ~ 0
B1
Text GLabel 9285 1345 2    50   Input ~ 0
B2
$Comp
L sd_card_spi P5
U 1 1 5A89AD86
...
U 1 1 5A89DD80
P 1900 3850
F 0 "#PWR4" H 1900 3700 50  0001 C CNN
...
U 1 1 5A8A120C
P 3050 5200
F 0 "#PWR9" H 3050 4950 50  0001 C CNN
...
Feb 16, 2018\n
Text GLabel 8035 2245 3    50   Input ~ 0
CS
Text GLabel 8435 2245 3    50   Input ~ 0
MOSI
Text GLabel 8535 2245 3    50   Input ~ 0
CLK
Text GLabel 8135 2245 3    50   Output ~ 0
MISO
$Comp
L +3.3V #PWR21
U 1 1 5A8ACE92
P 8750 4150
F 0 "#PWR21" H 8750 4000 50  0001 C CNN
...
U 1 1 5A8B6B0C
P 8600 4600
F 0 "#PWR20" H 8600 4350 50  0001 C CNN
...
U 1 1 5A8BA4F2
P 9050 6200
F 0 "#PWR22" H 9050 5950 50  0001 C CNN
...
RST
Text GLabel 7385 1045 0    50   Input ~ 0
RST
$Comp
L CONN_01X04 P2
U 1 1 5A8CEAAB
...
U 1 1 5A8CF103
P 3700 6000
F 0 "#PWR10" H 3700 5850 50  0001 C CNN
...
U 1 1 5A8CF265
P 4650 4300
F 0 "#PWR13" H 4650 4150 50  0001 C CNN
...
U 1 1 5A8CFC33
P 4650 4900
F 0 "#PWR14" H 4650 4650 50  0001 C CNN
...
NoConn ~ 10550 5450
NoConn ~ 10550 5350
Text GLabel 7385 1645 0    50   Output ~ 0
SCL
Text GLabel 7385 1545 0    50   Output ~ 0
SDA
Wire Wire Line
	3000 6550 2900 6550
Wire Wire Line
...
U 1 1 5A8E4EC2
P 9385 1745
F 0 "R3" H 9235 1695 50  0000 L CNN
F 1 "1k" H 9235 1795 50  0000 L CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" H 9385 1745 50  0001 C CNN
F 3 "" H 9385 1745 50  0000 C CNN
	1    9385 1745
	-1   0    0    1   
$EndComp
Wire Wire Line
...
Wire Wire Line
	5650 7150 5800 7150
Text GLabel 9285 1445 2    50   Input ~ 0
GPIO0
Wire Wire Line
	9035 1445 9285 1445
...
U 1 1 5A9146B5
P 5700 5150
F 0 "#PWR15" H 5700 4900 50  0001 C CNN
...
U 1 1 5A914774
P 6200 5150
F 0 "#PWR18" H 6200 4900 50  0001 C CNN
...
U 1 1 5A916FB2
P 6200 3850
F 0 "#PWR17" H 6200 3700 50  0001 C CNN
...
Text GLabel 7385 1345 0    50   Output ~ 0
IRL
Text GLabel 7385 1445 0    50   Input ~ 0
IRT
Wire Wire Line
	7385 1445 7535 1445
Wire Wire Line
...
U 1 1 5A92B353
P 7285 1245
F 0 "R1" H 7185 1145 50  0000 L CNN
F 1 "10k" V 7285 1195 50  0000 L CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" H 7285 1245 50  0001 C CNN
F 3 "https://www.mouser.com/ds/2/447/Yageo_08112016_RC0805-1211991.pdf" H 7285 1245 50  0001 C CNN
F 4 "RC0805FR-0710KL" H 7285 1245 60  0001 C CNN "PartNo"
	1    7285 1245
	0    1    1    0   
$EndComp
...
U 1 1 5A8CEBE7
P 10230 1120
F 0 "R15" H 10260 1140 50  0000 L CNN
F 1 "10K" H 10260 1080 50  0000 L CNN
F 2 "" H 10230 1120 50  0000 C CNN
F 3 "" H 10230 1120 50  0000 C CNN
	1    10230 1120
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A8CED38
P 10230 940
F 0 "#PWR24" H 10230 790 50  0001 C CNN
F 1 "+3.3V" H 10230 1080 50  0000 C CNN
F 2 "" H 10230 940 50  0000 C CNN
F 3 "" H 10230 940 50  0000 C CNN
	1    10230 940 
	1    0    0    -1  
$EndComp
Wire Wire Line
	10230 940  10230 1020
Wire Wire Line
	10230 1220 10230 1315
Text Label 10230 1315 3    60   ~ 0
GPIO2
Text Label 9050 1545 0    60   ~ 0
GPIO2
$EndSCHEMATC
